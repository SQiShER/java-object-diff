...
public enum PrimitiveDefaultValueMode
{
	 ...
	 * change to a primitive value will be marked as {@linkplain DiffNode.State#CHANGED}.
	 */
	ASSIGNED,
	 ...
	 * DiffNode.State#ADDED} and from something else to the default value as {@linkplain
